...
export const BranchSVG = (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => {
  return (
...
export const CloudSVG = (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' width='40' height='55' {...props} viewBox='0 0 80.672 76.043'>
      <g id='Group_137' data-name='Group 137' transform='translate(-102.752 -1403.957)'>
        <path id='Path_1322' data-name='Path 1322' d='M479.77,885.877H458.346V871.594a11.9,11.9,0,0,1,11.9-11.9h2.381V852.55a11.9,11.9,0,0,1,11.9-11.9h26.186a11.9,11.9,0,0,1,11.9,11.9v11.9h0a11.9,11.9,0,0,1,11.9,11.9v9.522H513.1' transform='translate(-353.346 565.557)' fill='none' stroke='#90ebcd' strokeMiterlimit='10' strokeWidth='4.497' />
        <line id='Line_436' data-name='Line 436' y2='45.229' transform='translate(143.088 1434.771)' fill='none' stroke='#0c322c' strokeMiterlimit='10' strokeWidth='4.497' />
        <path id='Path_1324' data-name='Path 1324' d='M486.912,873.975V897.78H467.868' transform='translate(-353.346 565.557)' fill='none' stroke='#0c322c' strokeMiterlimit='10' strokeWidth='4.497' />
        <path id='Path_1325' data-name='Path 1325' d='M505.956,873.975v30.947H525' transform='translate(-353.346 565.557)' fill='none' stroke='#0c322c' strokeMiterlimit='10' strokeWidth='4.497' />
        <line id='Line_437' data-name='Line 437' x1='4.761' transform='translate(105 1463.337)' fill='none' stroke='#90ebcd' strokeMiterlimit='10' strokeWidth='4.497' />
        <line id='Line_439' data-name='Line 439' x2='4.761' transform='translate(176.415 1470.478)' fill='none' stroke='#90ebcd' strokeMiterlimit='10' strokeWidth='4.497' />
      </g>
    </svg>
  )
}

export const TorchSVG = () => {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' width='40' height='50' viewBox='0 0 50.165 94.973'>
      <g id='Group_138' data-name='Group 138' transform='translate(-706.524 -1387.275)'>
        <line id='Line_459' data-name='Line 459' x2='28.566' transform='translate(716.142 1441.912)' fill='none' stroke='#0c322c' strokeMiterlimit='10' strokeWidth='4.497' />
        <path id='Path_1342' data-name='Path 1342' d='M824.943,1020.8H829.7l2.38,19.809h9.522l2.38-19.809h4.761' transform='translate(-106.42 439.39)' fill='none' stroke='#0c322c' strokeMiterlimit='10' strokeWidth='4.497' />
        <line id='Line_460' data-name='Line 460' x1='23.805' transform='translate(718.522 1450.669)' fill='none' stroke='#0c322c' strokeMiterlimit='10' strokeWidth='4.497' />
        <path
          id='Path_1343'
          data-name='Path 1343'
          d='M840.837,950.461l10.35,8.019a2.124,2.124,0,0,1,.174,3.208l-21.746,20.983a8.214,8.214,0,0,0-1.93,3.247l-1.278,4.067a1.056,1.056,0,0,1-1.821.357l-8.626-10.407a2.347,2.347,0,0,1,.2-3.206L835.737,958.3a8.216,8.216,0,0,0,2.258-3.683l1.081-3.7A1.056,1.056,0,0,1,840.837,950.461Z'
          transform='translate(-106.42 439.39)'
          fill='none'
          stroke='#fe7c3f'
          strokeMiterlimit='10'
          strokeWidth='4.497'
        ...
        <path
          id='Path_1344'
          data-name='Path 1344'
          d='M854.678,971.8a.589.589,0,0,0-.906-.112L837.2,987.507a3.215,3.215,0,0,0-.943,2.275h0A3.218,3.218,0,0,0,839.476,993h9.5a4.134,4.134,0,0,0,3.038-1.331l8.2-8.883a1.646,1.646,0,0,0-.046-2.28Z'
          transform='translate(-106.42 439.39)'
          fill='none'
          stroke='#fe7c3f'
          strokeMiterlimit='10'
...
export const ContainerSVG = () => {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' width='40' height='43' viewBox='0 0 90.165 70.973'>
      <g data-name='Group 139' fill='none' strokeMiterlimit='10' strokeWidth='4.497'>
        <path data-name='Rectangle 133' stroke='#0c322c' d='M2.248 33.327h76.176v47.61H2.248z' />
        <path data-name='Rectangle 134' stroke='#30ba77' d='M11.77 42.849h28.566v28.566H11.77z' />
        <path data-name='Line 448' stroke='#30ba77' d='M49.858 40.468v33.327' />
        <path data-name='Line 449' stroke='#30ba77' d='M59.38 40.468v33.327' />
        <path data-name='Line 450' stroke='#30ba77' d='M68.902 40.468v33.327' />
        <path data-name='Path 1333' d='m7.009 33.326 33.327-19.044 33.327 19.044' stroke='#0c322c' />
        <path data-name='Line 451' stroke='#0c322c' d='M40.336 14.283V0' />
      </g>
    </svg>
  )
}
export const DecorationLineSVG = (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' width='2684' {...props}>
      <g data-name='Group 248'>
        <g data-name='Group 159'>
          <path data-name='Rectangle 623' fill='#fe7c3f' d='M1 0h183v12H1z' />
          <path data-name='Rectangle 624' fill='#2453ff' d='M184 0h68v12h-68z' />
          <path data-name='Rectangle 629' fill='#2453ff' d='M456 0h68v12h-68z' />
          <path data-name='Rectangle 625' fill='#30ba78' d='M252 0h68v12h-68z' />
          <path data-name='Rectangle 630' fill='#30ba78' d='M524 0h45v12h-45z' />
          <path data-name='Rectangle 626' fill='#0c322c' d='M320 0h68v12h-68z' />
          <path data-name='Rectangle 628' fill='#fff' d='M388 0h68v12h-68z' />
          <path data-name='Rectangle 627' fill='#90ebcd' d='M0 0h68v12H0z' />
        </g>
        <g data-name='Group 160'>
          <path data-name='Rectangle 623' fill='#fe7c3f' d='M456 0h183v12H456z' />
          <path data-name='Rectangle 624' fill='#2453ff' d='M639 0h68v12h-68z' />
          <path data-name='Rectangle 629' fill='#2453ff' d='M911 0h68v12h-68z' />
          <path data-name='Rectangle 625' fill='#30ba78' d='M707 0h68v12h-68z' />
          <path data-name='Rectangle 630' fill='#30ba78' d='M979 0h45v12h-45z' />
          <path data-name='Rectangle 626' fill='#0c322c' d='M775 0h68v12h-68z' />
          <path data-name='Rectangle 628' fill='#fff' d='M843 0h68v12h-68z' />
          <path data-name='Rectangle 627' fill='#90ebcd' d='M455 0h68v12h-68z' />
        </g>
        <g data-name='Group 161'>
          <path data-name='Rectangle 623' fill='#fe7c3f' d='M1092 0h183v12h-183z' />
          <path data-name='Rectangle 624' fill='#2453ff' d='M1277 0h68v12h-68z' />
          <path data-name='Rectangle 629' fill='#2453ff' d='M1553 0h68v12h-68z' />
          <path data-name='Rectangle 625' fill='#30ba78' d='M1346 0h68v12h-68z' />
          <path data-name='Rectangle 630' fill='#30ba78' d='M1621 0h45v12h-45z' />
          <path data-name='Rectangle 626' fill='#0c322c' d='M1415 0h68v12h-68z' />
          <path data-name='Rectangle 628' fill='#fff' d='M1484 0h68v12h-68z' />
          <path data-name='Rectangle 627' fill='#90ebcd' d='M1091 0h68v12h-68z' />
        </g>
        <g data-name='Group 164'>
          <path data-name='Rectangle 623' fill='#fe7c3f' d='M1535 0h183v12h-183z' />
          <path data-name='Rectangle 624' fill='#2453ff' d='M1720 0h68v12h-68z' />
          <path data-name='Rectangle 629' fill='#2453ff' d='M1996 0h68v12h-68z' />
          <path data-name='Rectangle 625' fill='#30ba78' d='M1789 0h68v12h-68z' />
          <path data-name='Rectangle 630' fill='#30ba78' d='M2064 0h45v12h-45z' />
          <path data-name='Rectangle 626' fill='#0c322c' d='M1858 0h68v12h-68z' />
          <path data-name='Rectangle 628' fill='#fff' d='M1927 0h68v12h-68z' />
          <path data-name='Rectangle 627' fill='#90ebcd' d='M1534 0h68v12h-68z' />
        </g>
        <g data-name='Group 249'>
          <path data-name='Rectangle 623' fill='#fe7c3f' d='M2110 0h183v12h-183z' />
          <path data-name='Rectangle 624' fill='#2453ff' d='M2295 0h68v12h-68z' />
          <path data-name='Rectangle 629' fill='#2453ff' d='M2571 0h68v12h-68z' />
          <path data-name='Rectangle 625' fill='#30ba78' d='M2364 0h68v12h-68z' />
          <path data-name='Rectangle 630' fill='#30ba78' d='M2639 0h45v12h-45z' />
          <path data-name='Rectangle 626' fill='#0c322c' d='M2433 0h68v12h-68z' />
          <path data-name='Rectangle 628' fill='#fff' d='M2502 0h68v12h-68z' />
          <path data-name='Rectangle 627' fill='#90ebcd' d='M2109 0h68v12h-68z' />
        </g>
      </g>
    </svg>
  )
